...
export class PlaylistController {
    ...
    async getAllOwn(
        ...
        return await this.playlistService.getAllOwn(emailOwner, Number(page), Number(limit));
    }
    ...
    @Put()
    async updateUserEmail(@Body(ValidationPipe) updatePlaylistDto: UpdatePlaylistDto) {
